    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'Current e-mail cannot be registered'}, max_length=254, unique=True, verbose_name='email address')),
                ('tel_mobile', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region=None)),
                ('tel_other', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region=None)),
